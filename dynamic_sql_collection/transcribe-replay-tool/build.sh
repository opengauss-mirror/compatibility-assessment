...
cp target/transcribe-replay-tool-jar-with-dependencies.jar transcribe-replay-tool/transcribe-replay-tool-6.0.0.jar
...
tar -czf transcribe-replay-tool-6.0.0.tar.gz transcribe-replay-tool
rm -rf transcribe-replay-tool
mv transcribe-replay-tool-6.0.0.tar.gz target/